...
async def start(client, message):
    ...
    if len(message.command) > 1 and message.command[1] == "private":
        ...
        await send_message(message, unauth_start, buttons=sbutton)
